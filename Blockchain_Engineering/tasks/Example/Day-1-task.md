...
The goal of this task is to help you understand the basic concept of a Merkle Tree, its structure, and its importance in blockchain systems.
...
4. **Visual Representation**:
   - Draw a simple diagram of your Merkle Tree, labeling all nodes (leaf and non-leaf) with their corresponding hashes (shortened hashes are fine).
