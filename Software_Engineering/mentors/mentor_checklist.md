# TechNexus Cohort 2 — Mentor Checklist (Software Engineering)
...
```text
Software_Engineering/<Workshop-Name>/
├── tasks/
├── submissions/
└── resources/
```

Example: `Software_Engineering/Example-Workshop/`
...
- Example: `Software_Engineering/Example-Workshop/submissions/Day-1/`
